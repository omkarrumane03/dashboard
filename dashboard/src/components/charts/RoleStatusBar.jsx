...
const STATUS_ORDER = [
  'Active', 'Active – L1 Pending', 'On Hold', 'Not Started',
  'Partial Onboard', 'Dropped', 'Closed', 'No Update',
];
...
export default function RoleStatusBar() {
  ...
  // If selectedMonth is no longer in range, fall back to All
  ...
  return (
    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', fontFamily: "Inter, sans-serif", gap: 10 }}>
      ...
      {/* Month toggle — only available months in filtered range */}
        ...
        <div style={{ height: chartHeight }}>
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={chartData} layout="vertical"
              ...
              <Tooltip
                content={<CustomTooltip pipeline={filteredPipeline} />}
