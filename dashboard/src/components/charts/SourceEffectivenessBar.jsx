  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <BarChart data={sourceEffectiveness} margin={{ top: 20, right: 10, left: -10, bottom: 5 }} layout="vertical">
        ...
        <XAxis type="number" tick={{ fill: PALETTE.muted, fontSize: 10, fontFamily: "'JetBrains Mono', monospace" }} axisLine={{ stroke: PALETTE.border }} tickLine={false} />
        <YAxis type="category" dataKey="source" tick={{ fill: PALETTE.muted, fontSize: 10, fontFamily: "'JetBrains Mono', monospace" }} axisLine={false} tickLine={false} width={80} />
        <Tooltip content={<CustomTooltip />} />
        <Bar dataKey="hires" name="Hires" radius={[0, 4, 4, 0]}>
          <LabelList dataKey="hires" position="right" style={{ fill: PALETTE.muted, fontSize: 10, fontFamily: "'JetBrains Mono', monospace" }} />
